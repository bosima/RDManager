...
namespace Poderosa.Communication
{
    ...
    {
        internal delegate void OnClosedEventHandler(object sender, EventArgs args);
        internal event OnClosedEventHandler ClosedEvent;
        ...
        public abstract ConnectionTag Reproduce();
    ...
    internal class SSHTerminalConnection : TCPTerminalConnection, ISSHConnectionEventReceiver, ISSHChannelEventReceiver
    {
        ...
        public override ConnectionTag Reproduce()
        {
            ...
            if (sshp.Method == ConnectionMethod.SSH2 && !this.IsClosed)
            {
        ...
        internal override void Close()
        {
            ...
            try
            {
                if (_channel != null)
                {
                    var channelId = _channel.LocalChannelID;
                    _channel.Close();
                    _connection.UnregisterChannelEventReceiver(channelId);
                }
