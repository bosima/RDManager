...
namespace Poderosa.Config
{
    public class CommonOptions : ICloneable
    {
        ...
        [ConfigStringElement(Initial = "Microsoft YaHei")]
        ...
        protected Color _caretColor; //Color.Empty
    ...
    {
        [EnumValue(Description = "Enum.DisconnectNotification.MessageBox")]
        MessageBox,
        [EnumValue(Description = "Enum.DisconnectNotification.StatusBar")]
        StatusBar
    }
    ...
    {
        [EnumValue(Description = "Enum.RightButtonAction.ContextMenu")]
        ContextMenu,
        [EnumValue(Description = "Enum.RightButtonAction.Paste")]
        Paste
    }
